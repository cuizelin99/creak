...
true_out_file = sys.argv[3]
false_out_file = sys.argv[4]

all_lines = True

count = 16111

with open(true_out_file, "a") as toutfile:
	with open(false_out_file, "a") as foutfile:
